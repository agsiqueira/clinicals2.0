function buildPatientSystemPrompt(caseData) {
  ...
  return [
    ...
    "If visible_facts.allowed_this_turn contains exactly one fact, answer using only that one fact. Do not add related negatives, red flags, reassurance, or extra context.",
    "",
    ...
    "For broad questions, do not mention pertinent negatives, red flags, or reassuring details unless they are the one visible allowed fact.",
